...
export default class PhoneInput extends Component {
  ...
  updateFlagAndFormatNumber(number, actionAfterSetState = null) {
    ...
    if (number && number !== '') {
      ...
      console.log('index.js <  > ===> ', allowZeroAfterCountryCode);
    ...
    this.setState({
      ...
      formattedNumber: formattedPhoneNumber !== '' ?
        formattedPhoneNumber : this.state.formattedNumber,
      inputValue: number
    }, actionAfterSetState);
  }
  ...
  possiblyEliminateZeroAfterCountryCode(number) {
    ...
    console.log('index.js <  > ===> ' + dialCode + '=', number);
      ...
      <View style={[styles.container, this.props.style]}>
        ...
        >
          <Image
            ...
            onPress={this.onPressFlag}
          />
          <Text style={[styles.text, { marginLeft: 8, marginRight: 8 }]}>{this.getDialCode()}</Text>
        </TouchableOpacity>
